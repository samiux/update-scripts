...
'''
Description : RCCC HKI Duty List Calculator
Author      : Samiux
Date        : July 30, 2021
Version     : 0.1
'''
...
if team == 1:
	num_of_date = target_date - default_date_t1
elif team == 2:
	num_of_date = target_date - default_date_t2
elif team == 3:
	num_of_date = target_date - default_date_t3
elif team == 4:
	num_of_date = target_date - default_date_t4
